                  ...
                  <div className="d-flex" style={{ justifyContent: "space-between" }}>
                    <div>
                      ...
                      <Col md={8}>
                        ...
                        <div
                          className={` d-flex justify-content-center   bg-${changeColor(e.status)}`}
                    ...
                    <div>
                      <div>
                        <h5>Amenities</h5>
                        <p style={{ color: "grey" }}>
                          {e.property.amenities.map((value) => (
                            <p>{value}</p>
                          ))}
                        </p>
                      </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td style={{ fontWeight: "bold" }}>
                          {(Date.parse(e.check_out) - Date.parse(e.check_in)) / 86400000} Days
                        </td>
                      </tr>
                      <tr>
